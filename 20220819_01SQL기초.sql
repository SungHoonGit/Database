...
D:\java202207\database\2022089_01SQL기초.sql
////////////////////////////////////////////////////////////////////////////////
...
create table sungjuk(
    uname varchar(20)      --영문자 20글자 이내까지 한,글은 2칸 먹어 10글자 (3칸 먹게 속성입힐수 있음.)
    ,kor  int              --정수형
    ,eng  int
    ,mat  int
    ,tot  int
...
1. 행추가
형식) insert into 테이블명(칼럼명1, 칼럼2, 칼럼3, ~~~)
      values (값1, 값2, 값3. ~~~);
